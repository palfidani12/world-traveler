  ...
  return (
    <div>
      <section className="rounded-4xl border border-[#e2e8ed] bg-white px-6 py-7 shadow-[0_18px_55px_rgba(31,52,63,0.08)] sm:px-8 sm:py-9">
        <h2 className="text-4xl font-bold tracking-[-0.02em] text-[#212b33]">
          Profile Details
        </h2>
        ...
        <div className="mt-7 flex flex-wrap items-center gap-5">
          ...
          <div className="space-y-2">
            ...
            <button
              type="button"
              className="block px-3 text-sm font-semibold text-[#6a7882] transition hover:text-[#364550]"
            >
              Remove
            </button>
          </div>
        ...
        <form className="mt-8">
          <div className="grid gap-5 sm:grid-cols-2">
            <label className="block">
              <span className="text-sm font-bold uppercase tracking-[0.08em] text-[#667580]">
                First Name
              </span>
              <input
                type="text"
          ...
          <div className="mt-7">
            <p className="text-sm font-bold uppercase tracking-[0.08em] text-[#667580]">
          ...
          <div className="mt-9 flex items-center justify-end gap-4 border-t border-[#eff3f6] pt-6">
            <button
              type="button"
              className="px-4 py-2 text-xl font-semibold text-[#3d6276] transition hover:text-[#274654]"
            >
              Cancel
            </button>
            <button
